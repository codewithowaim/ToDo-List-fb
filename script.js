...
import { collection, addDoc, onSnapshot, query, deleteDoc, doc } from "./db.js";
...
// document.querySelectorAll("#delete").addEventListener("click", function(event){
//      deleteTask(event)
// })
// async function deleteTask(event) {
//     e.preventdefault()
//     await deleteDoc(doc(db, "ToDoTask", docSnap.id));
